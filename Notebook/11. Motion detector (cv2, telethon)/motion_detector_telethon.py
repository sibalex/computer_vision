...
from telethon.tl.functions.contacts import GetFullChannelRequest
from telethon.tl.functions.contacts import GetFullChatRequest
from telethon.tl.types import InputChanell
...
while True:
	...
	for c in cnts:
		if cv2.contoursArea(c) < args["min_area"]:
			continue
